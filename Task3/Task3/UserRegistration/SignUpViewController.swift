...
class SignUpViewController: UIViewController {
    ...
    @IBAction func openDatePicker(){
        ...
        let nextView = self.storyboard?.instantiateViewController(withIdentifier: "DateOfBirthViewController") as! DateOfBirthViewController
        nextView.backController = self
        self.navigationController?.pushViewController(nextView, animated: true)
  
    }
    
    @IBAction func btnAPassEye(){
    ...
    @IBAction func btnAConfirmPassEye(){
    ...
    func signUPAPICall(){
        ...
        ReUsableFunc.alertShow(title: "", message: Constants.signUp, controller: self)
