...
class CollectionViewController: UIViewController {
   ...
   //    var loadingView: LoadingReusableView?
       ...
       override func viewDidLoad() {
           ...
           self.collectionView.register(itemCellNib, forCellWithReuseIdentifier: "CollectionViewItemCell")

           //Register Loading Reuseable View
           let loadingReusableNib = UINib(nibName: "LoadingCollectionViewCell", bundle: nil)
           collectionView.register(loadingReusableNib, forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: "LoadingCollectionViewCell")
   ...
   extension CollectionViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
       ...
       func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
           if kind == UICollectionView.elementKindSectionFooter {
               let aFooterView = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "LoadingCollectionViewCell", for: indexPath) as! LoadingCollectionViewCell
             //  cell.loadingView = aFooterView
              // cell.loadingView?.backgroundColor = UIColor.clear
               return aFooterView
           }
