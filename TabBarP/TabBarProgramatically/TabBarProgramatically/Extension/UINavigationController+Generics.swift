...
extension UINavigationController{
    ...
    func updateAttributes(isTranslucent: Bool = false, tintColor: UIColor? = nil, navBarColor: UIColor? = nil){
        ...
        let navBarTintColor = navBarColor ?? UIColor.black
        let navTintColor = tintColor ?? UIColor.white
        let titleAttributes:[NSAttributedString.Key:AnyObject] = [NSAttributedString.Key.font:UIFont.systemFont(ofSize: 21),NSAttributedString.Key.foregroundColor: tintColor ?? UIColor.black]
